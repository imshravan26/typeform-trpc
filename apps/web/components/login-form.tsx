"use client";
/* Enhanced: quiet editorial dark login card and amber-focused controls. */
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <FieldGroup className="gap-5">
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="font-serif text-4xl font-normal italic tracking-normal">
                  Welcome back.
                </h1>
                <p className="text-balance text-sm text-[var(--text-secondary)]">
              ...
              <Field className="gap-1.5">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto font-mono text-xs text-[var(--text-secondary)] underline-offset-2 hover:text-[var(--accent)] hover:underline"
                  >
              ...
              <FieldSeparator className="font-mono text-xs text-[var(--text-muted)] *:data-[slot=field-separator-content]:bg-card">
                Or continue with
              </FieldSeparator>
              <Field className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="border-[var(--border)]">
